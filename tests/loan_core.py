...
class LoanCore(LibCommon.Ownable):
    ...
    def start_loan(
        ...
        self._verify_permitted_caller(sp.sender)
    ...
    def whitelist_origination_controller(self, origination_controller_address):
        ...
        self._only_owner()
        self.data.origination_controllers[origination_controller_address] = True
    ...
    def _verify_permitted_caller(self, caller):
        sp.verify(self.data.origination_controllers.contains(
            caller) == True, "ORIGINATOR_NOT_AUTHORIZED")
    ...
    def _get_initial_storage(self):
        ...
        storage["origination_controllers"] = sp.big_map(
